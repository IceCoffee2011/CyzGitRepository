...
BEGIN
	-- 设置权限
	UPDATE QPAccountsDB.dbo.AccountsInfo SET UserRight=UserRight|@dwAddRight WHERE UserID=@dwUserID
	UPDATE QPAccountsDB.dbo.AccountsInfo SET UserRight=(~@dwRemoveRight)&UserRight WHERE UserID=@dwUserID	
END
