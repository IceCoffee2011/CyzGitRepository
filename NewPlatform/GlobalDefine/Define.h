...
//头像大小
#define FACE_CX						60									//头像宽度
#define FACE_CY						60									//头像高度

#define FACE_CX_2D					32									//头像宽度（缺省2D头像）
#define FACE_CY_2D					32									//头像高度

#define FACE_CX_3D					92									//头像宽度（缺省3D头像）
#define FACE_CY_3D					155									//头像高度

#define ONE_ROW_FACE_COUNT_3D		2									//行头像数
#define ONE_FACE_COUNT_3D			8									//头像个数
//长度定义
#define LEN_LESS_ACCOUNTS			4									//最短帐号
#define LEN_LESS_NICKNAME			4									//最短昵称
#define LEN_LESS_PASSWORD			6									//最短密码

//人数定义
#define MAX_CHAIR					100									//最大椅子
#define MAX_TABLE					100									//最大桌子
#define MAX_COLUMN					32									//最大列表
#define MAX_ANDROID					1024								//最大机器
#define MAX_PROPERTY				128									//最大道具
#define MAX_WHISPER_USER			16									//最大私聊
//#define MAX_TABLE_OPTION			20									//同一房间最多的桌子种类配置
...
#define PRIME_ANDROID_USER			1025L								//机器人数
...
#define LEN_SESSION_ID				64									//SessionID长度
...
#define LEN_TABLENAME					32									//桌名长度
#define LEN_URL							256									//地址长度
#define LEN_CUSTOMRULE					1024								//用户自定义规则长度
#define LEN_CUSTOMTABLEPASSWORD			9									//自建桌子密码
#define LEN_CUSTOMTABLEPROPERTYCONFIG	2									//自建房间道具消耗数量配置
...
#define GAME_GENRE_USERCUSTOM		0x0010								//用户自定类型
...
#define US_TRUSTEE					0x07								//托管状态(断线或者强退导致的托管,非主动托管)
...
#define CUSTOMTABLE_INIT_SCORE			1000000			// 开房模式初始化分数
