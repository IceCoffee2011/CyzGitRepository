...
//	CSkinEdit						m_edSeatPhone;							//固定电话
	...
	CSkinEditEx						m_edPassPortID;							// 身份证
//	CSkinEdit						m_edCompellation;						//真实名字
//	CSkinEdit						m_edDwellingPlace;						//联系地址
	CSkinEditEx						m_edGameID;								// 用户ID
	CSkinEditEx						m_edGender;								// 用户性别
	CSkinEditEx						m_edMember;								// 会员级别
	CSkinEditEx						m_edUserMedal;							// 用户奖牌
	CSkinEditEx						m_edUnderWrite;							// 个人签名编辑框

	CToolTipCtrl					m_ToolTipCtrl;							//提示控件

protected:
//	CSkinHyperLink					m_hlGameID;								// 用户ID
...
//	CSkinButton						m_btSelectFace;							//选择按钮
	...
	CSkinButton						m_btUnderWrite;							// 编辑个性签名
