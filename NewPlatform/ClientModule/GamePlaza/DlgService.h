...
#define SERVICE_INDIVIDUAL			0									//个人资料
...
#define SERVICE_LOCK_MACHINE		1									// 锁定机器
#define SERVICE_BIND_MOBILE			3									// 绑定手机
...
//	CDlgServiceBrowser				m_DlgServiceBrowser6;				//网页连接
	...
	//程序服务
public:
	CDlgServicePassword				m_DlgServicePassword;				// 修改登录密码
	CDlgServiceIndividual			m_DlgServiceIndividual;				// 基本资料
	CDlgServiceLockMachine			m_DlgServiceLockMachine;			// 锁定机器
	CDlgServiceBindMobile			m_DlgServiceBindMobile;				// 绑定手机
