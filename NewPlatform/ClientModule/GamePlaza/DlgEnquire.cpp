...
BOOL CDlgEnquire::OnInitDialog()
{
	...
	m_btCancel.SetButtonImage(IDB_BT_ENQUIRE_CLOSE, hInstance,false,false);
	...
	m_btCancel.SetWindowPos(NULL,SizeWindow.cx-rcCancel.Width()-13,5,0,0,SWP_NOZORDER|SWP_NOSIZE|SWP_NOREDRAW);
	...
	m_btClosePlaza.SetWindowPos(NULL,nButtonSpace*3+rcButton.Width()*2,90,0,0,SWP_NOZORDER|SWP_NOSIZE|SWP_NOREDRAW);
	m_btCloseServer.SetWindowPos(NULL,nButtonSpace*2+rcButton.Width()*1,90,0,0,SWP_NOZORDER|SWP_NOSIZE|SWP_NOREDRAW);
	m_btSwitchAccounts.SetWindowPos(NULL,nButtonSpace*1+rcButton.Width()*0,90,0,0,SWP_NOZORDER|SWP_NOSIZE|SWP_NOREDRAW);
