#ifndef PLAZA_USER_INFO_DLG_EX_HEAD_FILE
#define PLAZA_USER_INFO_DLG_EX_HEAD_FILE
...
//用户信息
class CUserInfoDlgEx : public CDialog
{
	//状态变量
protected:
...
public:
	//更新信息
	VOID UpdateUserInfo(IClientUserItem* pUserData, CString strName=TEXT(""));
    //设置接口
...
public:
	...
	DECLARE_MESSAGE_MAP()
	DECLARE_DYNAMIC(CUserInfoDlgEx)
};
