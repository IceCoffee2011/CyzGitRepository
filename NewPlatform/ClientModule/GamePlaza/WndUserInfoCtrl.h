...
class CWndUserInfoCtrl : public CWnd
{
	//控件变量
public:
	CSkinButton						m_btUserInfoSet;					//用户设置按钮
	CSkinButton						m_btUserInfoCopy;					//复制昵称
	CSkinButton						m_btSystemSet;						// 系统设置按钮

	//6603盘旋标志
protected:
	bool							m_bHoverFace;						//6603盘旋标志

	//6603状态变量
protected:
	bool							m_bClickFace;						//6603点击标志
	bool							m_bMouseEvent;						//6603注册标志

	//6603区域位置
protected:
	CRect							m_rcFaceArea;						//6603头像区域
