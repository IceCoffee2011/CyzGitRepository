...
//平台框架
class CPlatformFrame : public CFrameWnd, public IViewItemEvent, public ICustomFaceEvent
{
	//界面变量
protected:
	...
	CRect							m_rcTitleText;						//标题文字区域				
	DWORD							m_dwAllOnLineCount;                 //总在线人数
	CRect							m_rcLastGameServer;					// 最近游戏
...
public:
	...
	CSkinButton						m_btNavigation[6];					//导航按钮
...
protected:
	...
	// 最近游戏
protected:
	CLastGameServerCtrl				m_LastGameServerCtrl;				// 最近游戏控件
...
protected:
	...
	//框架顶部
protected:
	CBitImage						m_ImageHeadBarLeft;					//头部bar左边
	CBitImage						m_ImageHeadBarMiddle;				//头部bar中间
	CBitImage						m_ImageHeadBarRight;				//头部bar右边
...
protected:
	...
	// 最近游戏控件移动
	LRESULT OnMessageLastGameServerCtrlMove(WPARAM wParam, LPARAM lParam);
