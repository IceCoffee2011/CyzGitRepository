...
protected:
	...
	CSkinHyperLink					m_AgreeAgreement;					//同意条款
...
protected:
	...
	//删除记录
	VOID OnBnClearAccount();
	//找回密码
	VOID OnBnFindPass();
	// 同意条款
	VOID OnBnClickedAgreeAgreement();
...
protected:
	...
	DECLARE_MESSAGE_MAP()
public:
	afx_msg void OnBnClickedCheckRempass();
};
