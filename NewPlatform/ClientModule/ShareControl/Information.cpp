...
//字符偏移
#define SMB_STRING_TOP				15									//字符偏移
#define SMB_STRING_LEFT				20									//字符偏移
#define SMB_STRING_RIGHT			20									//字符偏移
#define SMB_STRING_WIDTH			455									//最大宽度
#define SMB_STRING_HEIGHT			250									//最大高度

//按钮偏移
#define SMB_BUTTON_TOP				35									//按钮偏移
#define SMB_BUTTON_LEFT				40									//按钮偏移
#define SMB_BUTTON_RIGHT			12									//按钮偏移
#define SMB_BUTTON_BOTTOM			20									//按钮偏移
#define SMB_BUTTON_SPACE			20									//按钮间隔
#define SMB_BUTTON_WIDTH			80									//按钮偏移
