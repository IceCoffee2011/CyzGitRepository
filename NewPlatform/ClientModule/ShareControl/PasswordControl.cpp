...
VOID CPasswordControl::PreSubclassWindow()
{
	...
	// iii 调整位置
	SetWindowPos(NULL,0,0,rcWindow.Width(),18,SWP_NOMOVE|SWP_NOZORDER|SWP_NOCOPYBITS);
	m_btKeyboard.SetWindowPos(NULL,rcClient.Width()-20,0,0,0,SWP_NOSIZE|SWP_NOZORDER|SWP_NOCOPYBITS|SWP_NOACTIVATE);
