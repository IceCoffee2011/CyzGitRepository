...
#define COLOR_MYSELF_BK				RGB(131,188,216)					//背景颜色
#define COLOR_MASTER_TX				RGB(255,0,0)						//字体颜色
#define COLOR_MASTER_BK				RGB(190,220,235)					//背景颜色
#define COLOR_MEMBER_TX				RGB(255,0,0)						//字体颜色
#define COLOR_MEMBER_BK				RGB(190,220,235)					//背景颜色*/
//#define COLOR_SELECT_BK				RGB(177,208,228)					//背景颜色


#define COLOR_SELECT_TX				RGB(78,128,152)						//字体颜色
#define COLOR_SELECT_BK				RGB(229,249,255)					//背景颜色
#define COLOR_NORMAL_TX				RGB(78,128,152)						//字体颜色
#define COLOR_NORMAL_BK				RGB(229,249,255)					//背景颜色
#define COLOR_HOVER_TX				RGB(78,128,152)						//字体颜色
#define COLOR_HOVER_BK				RGB(177,208,228)					//背景颜色

//默认颜色
#define COLOR_MYSELF_TX				RGB(78,128,152)						//字体颜色
#define COLOR_MYSELF_BK				RGB(229,249,255)					//背景颜色
#define COLOR_MASTER_TX				RGB(78,128,152)						//字体颜色
#define COLOR_MASTER_BK				RGB(229,249,255)					//背景颜色
#define COLOR_MEMBER_TX				RGB(78,128,152)						//字体颜色
#define COLOR_MEMBER_BK				RGB(229,249,255)					//背景颜色
...
struct tagColorUserList
{
	...
	COLORREF						crHoverTX;							//字体颜色
	COLORREF						crHoverBK;							//背景颜色
