...
bool CEncircleBMP::DrawEncircleFrame(CDC * pDC, CRect & rcEncircle)
{
	...
	//绘画四角
	EncircleImage.ImageTL.TransDrawImage(pDC,rcEncircle.left,rcEncircle.top,RGB(255,0,255));
	EncircleImage.ImageTR.TransDrawImage(pDC,rcEncircle.right-SizeImageTR.cx,rcEncircle.top,RGB(255,0,255));
	EncircleImage.ImageBL.TransDrawImage(pDC,rcEncircle.left,rcEncircle.bottom-SizeImageBL.cy,RGB(255,0,255));
	EncircleImage.ImageBR.TransDrawImage(pDC,rcEncircle.right-SizeImageBR.cx,rcEncircle.bottom-SizeImageBR.cy,RGB(255,0,255));
