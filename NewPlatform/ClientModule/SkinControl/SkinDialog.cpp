...
{
	//设置颜色
//	m_crTitleText=RGB(192,235,255);
//	m_crTitleFrame=RGB(192,235,255);
	...
	//设置视图
	m_EncircleInfoView.nBBorder=m_EncircleInfoFrame.nBBorder;
...
VOID CSkinDialog::DrawSystemTitle(CDC * pDC, INT nWdith, INT nHeight)
{
	...
	if (strTitle.IsEmpty()==false)
	{
		//计算区域
		CRect rcTitle;
		rcTitle.SetRect(30,0,nWdith-95,28);
