...
public:
	...
	bool LocateFile( const char* szFileName, int iCaseSensitivity );
	...
	bool PerpareUnzipFile(LPTSTR lpFileName,LPCTSTR szFolder = NULL);  //[Jordon 050521] 解压前的预备工作
	//Modified by jhuix 20050714
	bool UnzipFile(LPCTSTR szFolder = NULL,LPTSTR lpFileName = NULL, 
		bool bIgnoreFilePath = FALSE,bool bUnzipToTmpFile = FALSE,
		LPCTSTR lpszSuffixName = NULL); 
