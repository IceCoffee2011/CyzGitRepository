...
//		_sntprintf(szRuleUrl,CountArray(szRuleUrl),TEXT("%s/gamerule/rule?GameID=%ld&KindID=%ld"),szPlatformLink,pGameAttribute->wKindID,pGameAttribute->wKindID);
		//获取配置文件
		...
		_sntprintf(szBrowser,CountArray(szBrowser), szGameRule, pGameAttribute->wKindID);
