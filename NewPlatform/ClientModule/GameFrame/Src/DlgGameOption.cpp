...
// BEGIN_MESSAGE_MAP(CGeneralOptionItem, CDialog)
// 	ON_WM_ERASEBKGND()
// END_MESSAGE_MAP()
...
//绘画背景
// BOOL CGeneralOptionItem::OnEraseBkgnd(CDC * pDC)
// {
// 	//获取位置
// 	CRect rcClient;
...
//			cx-SPACE_LEFT-SPACE_RIGHT-nLViewBorder*2,cy-nTViewBorder-SPACE_TOP-SPACE_BOTTOM-nRViewBorder);
		m_SkinTabControl.MoveWindow( nLBorder-4, 36, rcClient.Width() - nLBorder - nRBorder + 8, rcClient.Height()- nTBorder - nTBorder + 36);
...
// 改变控件颜色
HBRUSH CDlgGameOption::OnCtlColor(CDC * pDC, CWnd * pWnd, UINT nCtlColor)
{
	switch (nCtlColor)
	{
	case CTLCOLOR_BTN:
