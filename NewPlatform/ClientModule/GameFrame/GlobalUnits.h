...
public:
	...
	//播放声音
	bool PlayGameSound(HINSTANCE hInstance, LPCTSTR pszSoundName, LPCTSTR pszTypeName = _T("WAVE"));
	//播放声音
	bool PlayBackGroundSound(LPCTSTR pszSoundName);
	//播放声音
	bool PlayBackGroundSound(HINSTANCE hInstance, LPCTSTR pszSoundName, LPCTSTR pszTypeName = _T("WAVE"));
	//停止声音
	bool StopSound();
