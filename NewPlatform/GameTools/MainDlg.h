...
private:
	bool EncryptFile(const CString& strFile, BOOL bDeleteSourceFile);
	bool DecryptFile(const CString& strFile, BOOL bDeleteSourceFile);
	bool EncryptFileFoder(const CString& strFileFoder, BOOL bSubFoder, BOOL bDeleteSourceFile);
	bool DecryptFileFoder(const CString& strFileFoder, BOOL bSubFoder, BOOL bDeleteSourceFile);
};
