...
protected:
	...
	tagGameServiceTableOption		m_GameServiceTableOption;			//桌子配置
public:
	vector<tagGameSquareOption>		m_vGameSquareOption;				//广场赛配置
...
public:
	...
	CDataBaseEngineSink				m_RecordDataBaseSink[1];			//数据钩子
	CDataBaseEngineSink				m_KernelDataBaseSink[1];			//数据钩子
...
public:
	...
	//游戏配置
	bool CollocateService(LPCTSTR pszGameModule, tagGameServiceOption & GameServiceOption, tagGameServiceTableOption& GameServiceTableOption);
	//广场赛配置
	bool CollocateSquareMatch(tagGameSquareOption GameSquareOptionArray[], BYTE cbGameSquareOptionArrayCount);
	//更新广场赛配置
	bool UpdateSquareMatch(tagGameSquareOption GameSquareOptionArray[], BYTE cbGameSquareOptionArrayCount);
