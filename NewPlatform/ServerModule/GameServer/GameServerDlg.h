...
protected:
	...
	//获取连接
	bool InitPlatformDBParameter(tagDataBaseParameter & DataBaseParameter);
	bool InitUserCustomDBParameter(tagDataBaseParameter & DataBaseParameter);
...
protected:
	...
	//加载广场赛
	VOID OnBnClickedLoadSquareMatch();
