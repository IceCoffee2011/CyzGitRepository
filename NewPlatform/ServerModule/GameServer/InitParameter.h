...
public:
	...
	tagDataBaseParameter			m_TreasureDBParameter;				//财富数据库连接地址
	tagDataBaseParameter			m_PlatformDBParameter;				//平台数据库连接地址
	tagDataBaseParameter			m_UserCustomDBParameter;			// 用户自定义桌子数据库
