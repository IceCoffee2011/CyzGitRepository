...
#else
typedef vector<COverLappedSend *> COverLappedSendPtr;
typedef vector<COverLappedRecv *> COverLappedRecvPtr;
#endif
...
#else
typedef vector<CServerSocketItem*> CServerSocketItemPtrArray;
typedef vector<CServerSocketRSThread*> CServerSocketRSThreadPtrArray;
#endif // !_NO_WHARRAY_
