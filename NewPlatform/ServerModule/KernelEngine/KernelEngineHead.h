...
typedef boost::variant<unsigned char, unsigned short, short, int, long, unsigned long, unsigned int, double, __int64, tm, std::wstring, std::string, bool, otl_long_string > CDBVarValue;
