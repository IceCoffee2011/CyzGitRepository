...
protected:
	...
	tagGameSquareOption *			m_pGameSquareOption;					//比赛配置
//	tagGameTableInfo*				m_pGameTableOption;						//桌子配置
...
public:
	...
	afx_msg void OnBnClickedBtnTableOption();
};
...
protected:
	...
	tagDBGameTableInfo*				m_pGameTableInfo;

	//函数定义
public:
	//构造函数
	CDlgServerOptionItemCustom();
	CDlgServerOptionItemCustom(CDlgServerWizard* pDlgServerWizard, tagDBGameTableInfo* pTableConfig);
	//析构函数
...
protected:
	...
	tagGameSquareOption *			m_pGameSquareOption;				//比赛配置
//	tagGameTableInfo*				m_pGameTableOption;					//桌子配置
	vector<tagDBGameTableInfo>*		m_pVectGameTableInfo;				// 桌子配置
...
public:
	...
	//设置配置
	VOID SetWizardParameter(IGameServiceManager * pIGameServiceManager, tagGameServiceOption * pGameServiceOption, vector<tagDBGameTableInfo>* pVectGameTableInfo = nullptr);
