...
#else
typedef vector<tagTimerItem *>		CTimerItemArray;					//时间数组
#endif
...
//	SCORE							m_lTakeScorePoint;					// 需要取钱的临界点数
//	SCORE							m_lSaveScorePoint;					// 需要存钱的临界点数
...
public:
	// 得到需要取钱的最小临界点
	virtual SCORE GetTakeScorePoint() { return m_AndroidService.lTakeScorePoint; };			
	// 得到需要存钱的最大临界点
	virtual SCORE GetSaveScorePoint() { return m_AndroidService.lSaveScorePoint; };
};
